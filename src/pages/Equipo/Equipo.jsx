  ...
  const equipo = [
    {
      ...
      desc: "Expert in game design, mechanics, and programming, leading the vision and development of our games.",
      img: getImg('jehosua'),
    },
    {
      nombre: "Kenneth",
      rol: "Game Designer and Programmer",
      desc: "Game design and programming, crafting engaging mechanics and seamless gameplay.",
      img: getImg('kus'),
    },
    {
      nombre: "Andres",
      rol: "Lead Animator and Artist",
      desc: "Aniamtion and rigging, breathing life into characters.",
      img: getImg('huesos'),
    },
    {
      nombre: "Kendall",
      rol: "Art Director and Animator",
      desc: "Bring to Life new worlds with stunning style and visual storytelling.",
      img: getImg('animador'),
    },
    {
      nombre: "Estefania",
      rol: "2D & Character Artist",
      desc: "Concept Artist and Character Artist, creating captivating characters and immersive worlds.",
      img: getImg('fanny'),
    },
    {
      nombre: "Kender",
      rol: "Game Developer and Programmer",
      desc: "Game development and programming, crafting engaging mechanics.",
      img: getImg('jorge'),
    },
    {
      nombre: "Daniela",
      rol: "2D and 3D Artist",
      desc: "Bring to Life new worlds with stunning style and visual storytelling.",
      img: getImg('jorge'),
    },
    {
